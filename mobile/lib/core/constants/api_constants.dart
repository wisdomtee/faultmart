class ApiConstants {
  ...
  static const String baseUrl =
      'https://faultmart-backend.onrender.com';
  static const String webAppUrl =
      'https://faultmart.vercel.app';
  ...
  // AI
  static const String listingAssistant =
      '$baseUrl/api/ai/listing-assistant';
  ...
  static String favoriteByListing(String listingId) =>
      '$favorites/$listingId';
  ...
  static String reviewsByUser(String userId) =>
      '$reviews/user/$userId';

  static String reviewSummary(String userId) =>
      '$reviews/summary/$userId';

  static String reviewById(String reviewId) =>
      '$reviews/$reviewId';
